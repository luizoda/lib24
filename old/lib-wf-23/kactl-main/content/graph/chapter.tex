...
%	\kactlimport{PushRelabel.h}
	...
	\kactlimport[-l rawcpp]{MinCostMaxFlowBer.cpp}
	\kactlimport{EdmondsKarp.h}
	%\kactlimport{EdmondsKarp.h}
	\kactlimport{CirculationFlowDemands.cpp}
	%\kactlimport{Dinic.h}
	\kactlimport[-l rawcpp]{DinicBer.cpp}
	\kactlimport[-l rawcpp]{LowerBoundMaxFlow.cpp}
...
\section{DFS algorithms}
	...
	%\kactlimport{2sat.h}
	\kactlimport[-l rawcpp]{2SATUFMG.cpp}
...
\section{Heuristics}
	...
	\kactlimport[-l rawcpp]{TortoiseAndHare.cpp}
...
\section{Trees}
	...
	\kactlimport[-l rawcpp]{TreeIsomorphism.cpp}
